...
(function () {
  ...
  function fetchSteamGameName(appid) {
    ...
    return fetch(
      ...
      .catch(function (err) {
        backendLog(
          "RolacoTools: fetchSteamGameName error for " + appid + ": " + err,
        );
        return null;
      });
  }
  ...
  function showSettingsManagerPopup(forceRefresh, onBack) {
    ...
    function applySearchFilter() {
      ...
      const fixesSection = document.getElementById(
        "RolacoTools-installed-fixes-section",
      );
      ...
      const luaSection = document.getElementById(
        "RolacoTools-installed-lua-section",
      );
      ...
      if (luaSection && query && luaItems.length > 0 && visibleLua === 0) {
        if (!luaEmptySearch) {
          ...
          const listContainer = luaSection.querySelector("#RolacoTools-lua-list");
          if (listContainer) listContainer.appendChild(emptyEl);
        }
          ...
          if (hasUnknownGames) {
            ...
            infoBanner.innerHTML =
              ...
              t(
                ...
                "Games showing 'Unknown Game' were installed manually (not via RolacoTools).",
              ) +
              "</span>";
