// RolacoTools button injection (standalone plugin)
...
(function () {
  ...
  gamepadCSS.textContent = `
        ...
        .RolacoTools-button.active-focus,
        .RolacoTools-restart-button.active-focus {
  ...
  // ALL RolacoTools overlays that should block Steam navigation
  const OVERLAY_SELECTORS = [
    ".RolacoTools-overlay",
    ".RolacoTools-settings-overlay",
    ".RolacoTools-fixes-results-overlay",
    ".RolacoTools-loading-fixes-overlay",
    ".RolacoTools-unfix-overlay",
    ".RolacoTools-settings-manager-overlay",
    ".RolacoTools-alert-overlay",
    ".RolacoTools-confirm-overlay",
    ".RolacoTools-loadedapps-overlay",
  ];
  ...
  function isBigPictureMode() {
    if (typeof window.__RolacoTools_IS_BIG_PICTURE__ !== "undefined") {
      return window.__RolacoTools_IS_BIG_PICTURE__;
    }
  ...
  function scanFocusableElements() {
    ...
    // Only scan if there's a RolacoTools overlay active
    const activeOverlay = document.querySelector(OVERLAY_SELECTOR_STRING);

    if (!activeOverlay) {
      console.log("[Gamepad] No RolacoTools overlay active, skipping scan");
  ...
  function pollGamepad() {
    ...
    // Check if there's an active RolacoTools overlay
...
(function () {
  ...
  window.__RolacoTools_IS_BIG_PICTURE__ = isBigPictureMode();
  ...
  function backendLog(message) {
    try {
      if (
        ...
        Millennium.callServerMethod("RolacoTools", "Logger.log", {
          message: String(message),
        });
      }
    } catch (err) {
      if (typeof console !== "undefined" && console.warn) {
        console.warn("[RolacoTools] backendLog failed", err);
      }
    }
  }

  backendLog("RolacoTools script loaded");
  backendLog(
    "Mode Detection: " +
      (window.__RolacoTools_IS_BIG_PICTURE__ ? "BIG PICTURE MODE" : "NORMAL MODE"),
  );
  // anti-spam state
  const logState = {
    missingOnce: false,
  ...
  function fetchGamesDatabase() {
    ...
    return Millennium.callServerMethod("RolacoTools", "GetGamesDatabase", {
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[RolacoTools] Failed to fetch games database", err);
        return {};
      });
  }
  ...
  function fetchFixes(appid) {
    ...
    return Millennium.callServerMethod("RolacoTools", "CheckForFixes", {
      appid: appid,
      contentScriptQuery: "",
    })
      .then(function (res) {
      ...
      .catch(function (err) {
        console.warn("[RolacoTools] Failed to fetch fixes", err);
        return null;
      });
  }
  ...
  function applyTranslationBundle(bundle) {
    ...
    const stored = window.__RolacoToolsI18n || {};
    if (bundle.language) {
    ...
    window.__RolacoToolsI18n = stored;
  }
  ...
  const DEFAULT_THEMES = {
    original: {
      ...
      bgPrimary: "#08090d",
      bgSecondary: "#15171d",
      bgTertiary: "rgba(18, 20, 27, 0.96)",
      bgHover: "rgba(38, 34, 25, 0.96)",
      bgContainer: "rgba(11, 12, 17, 0.86)",
      bgContainerGradient: "rgba(20, 19, 16, 0.94), #08090d",
      accent: "#d6b56f",
      accentLight: "#f4dda5",
      accentDark: "#a7823b",
      border: "rgba(214,181,111,0.34)",
      borderHover: "rgba(244,221,165,0.82)",
      text: "#f8f4eb",
      textSecondary: "#b9b2a4",
      gradient: "linear-gradient(135deg, #f1d795 0%, #c39747 100%)",
      gradientLight: "linear-gradient(135deg, #fff0c5 0%, #ddb96e 100%)",
      shadow: "rgba(214,181,111,0.30)",
      shadowHover: "rgba(244,221,165,0.46)",
    },
  };
  ...
  function loadThemesFromBackend() {
    ...
    return Millennium.callServerMethod("RolacoTools", "GetThemes", {
      contentScriptQuery: "",
    })
      .then(function (res) {
        try {
  ...
  function getCurrentThemeKey() {
    try {
      const settings = window.__RolacoToolsSettings || {};
  ...
  function generateThemeStyles(theme) {
    const rgbString = hexToRgb(theme.accent).join(",");
    return `
            :root {
                --lt-bg-primary: ${theme.bgPrimary};
                --lt-bg-secondary: ${theme.bgSecondary};
                --lt-bg-tertiary: ${theme.bgTertiary};
                --lt-bg-hover: ${theme.bgHover};
                --lt-bg-container: ${theme.bgContainer};
                --lt-accent: ${theme.accent};
                --lt-accent-light: ${theme.accentLight};
                --lt-accent-dark: ${theme.accentDark};
                --lt-border: ${theme.border};
                --lt-border-hover: ${theme.borderHover};
                --lt-text: ${theme.text};
                --lt-text-secondary: ${theme.textSecondary};
                --lt-gradient: ${theme.gradient};
                --lt-gradient-light: ${theme.gradientLight};
                --lt-shadow: ${theme.shadow};
                --lt-shadow-hover: ${theme.shadowHover};
                --lt-rgb: ${rgbString};
            }
            ...
            .RolacoTools-settings-manager-overlay,
            .RolacoTools-loadedapps-overlay {
                background: rgba(${rgbString}, 0.12) !important;
                backdrop-filter: blur(8px) !important;
            }

            /* Prefer overlay-scoped select rules to override theme CSS files */
            .RolacoTools-settings-overlay select,
            .RolacoTools-settings-manager-overlay select,
            .RolacoTools-overlay select,
            .RolacoTools-fixes-results-overlay select,
            .RolacoTools-loadedapps-overlay select {
            ...
            .RolacoTools-settings-overlay select option,
            .RolacoTools-settings-manager-overlay select option,
            .RolacoTools-overlay select option,
            .RolacoTools-fixes-results-overlay select option,
            .RolacoTools-loadedapps-overlay select option {
                background-color: ${theme.bgPrimary} !important;
                color: ${theme.text} !important;
            }
            .RolacoTools-settings-overlay select option:checked,
            .RolacoTools-settings-manager-overlay select option:checked,
            .RolacoTools-overlay select option:checked,
            .RolacoTools-fixes-results-overlay select option:checked,
            .RolacoTools-loadedapps-overlay select option:checked {
                background: ${theme.accent} !important;
                color: ${theme.text} !important;
            }
            .RolacoTools-settings-overlay select:hover,
            .RolacoTools-settings-manager-overlay select:hover,
            .RolacoTools-overlay select:hover,
            .RolacoTools-fixes-results-overlay select:hover,
            .RolacoTools-loadedapps-overlay select:hover {
                border-color: ${theme.borderHover} !important;
            }
            .RolacoTools-settings-overlay select:focus,
            .RolacoTools-settings-manager-overlay select:focus,
            .RolacoTools-overlay select:focus,
            .RolacoTools-fixes-results-overlay select:focus,
            .RolacoTools-loadedapps-overlay select:focus {
            ...
            .RolacoTools-btn:hover:not([data-disabled="1"]) {
                background: ${theme.bgHover};
                transform: translateY(-2px);
                box-shadow: 0 6px 20px ${theme.shadowHover};
                border-color: ${theme.borderHover};
            }
            .RolacoTools-btn.primary {
            ...
            .RolacoTools-btn.primary:hover:not([data-disabled="1"]) {
            ...
            .RolacoTools-toggle-container {
                display: flex;
                align-items: center;
                justify-content: space-between;
                width: 100%;
            }
            .RolacoTools-toggle-label-wrap {
                display: flex;
            ...
            input:checked + .RolacoTools-slider {
                background-color: #1a9fff;
                border-color: #1a9fff;
            }
            input:checked + .RolacoTools-slider:before {
                transform: translateX(24px);
            }
            .RolacoTools-slider:hover {
                border-color: #1a9fff;
            }
            ...
            /* Store header button - RolacoTools themed icon button */
            button.RolacoTools-header-button {
                display: inline-flex;
                align-items: center;
            ...
            button.RolacoTools-header-button:hover {
                background: ${theme.bgHover};
                transform: translateY(-1px);
                box-shadow: 0 4px 12px ${theme.shadowHover};
                border-color: ${theme.borderHover};
            }
            button.RolacoTools-header-button:focus-visible {
                outline: 2px solid ${theme.accent};
                outline-offset: 2px;
            }
            button.RolacoTools-header-button img,
            button.RolacoTools-header-button svg {
                height: 16px;
                width: 16px;
            }
        `;
  ...
  function ensureThemeStylesheet(themeKey) {
    const id = "RolacoTools-theme-css";
    ...
    try {
      ...
      backendLog("RolacoTools: Theme CSS injection failed: " + err);
    }
  }

  function ensureRolacoToolsStyles() {
    const styleEl = document.getElementById("RolacoTools-styles");
    ...
    if (styleEl) {
      ...
      try {
        ...
        style.id = "RolacoTools-styles";
        style.textContent = styles;
        document.head.appendChild(style);
      } catch (err) {
        backendLog("RolacoTools: Styles injection failed: " + err);
      }
    }
  ...
  function ensureFontAwesome() {
    if (document.getElementById("RolacoTools-fontawesome")) return;
    try {
      const link = document.createElement("link");
      link.id = "RolacoTools-fontawesome";
      link.rel = "stylesheet";
      link.href =
      ...
      backendLog("RolacoTools: Font Awesome injection failed: " + err);
    }
  }

  function showCustomApiModal(onSuccess) {
    try {
      const old = document.querySelector(".RolacoTools-custom-api-overlay");
      if (old) old.remove();
    } catch (_) {}
    ...
    overlay.className = "RolacoTools-custom-api-overlay";
    ...
    saveBtn.onclick = function () {
      ...
      if (!name || !url) {
        ShowRolacoToolsAlert("Error", lt("Name and URL are required."));
        return;
      }
      ...
      try {
        ...
        ShowRolacoToolsAlert("Error", lt("Please enter a valid URL."));
        return;
      }

      if (!url.includes("<appid>")) {
        ShowRolacoToolsAlert("Error", lt("URL must contain <appid> placeholder."));
        return;
      }
      ...
      if (needsKey && !apiKey) {
        ShowRolacoToolsAlert("Error", lt("Please enter an API Key."));
        return;
      }
      ...
      Millennium.callServerMethod("RolacoTools", "AddCustomApi", {
        name: name,
        url: url,
        ...
        try {
          ...
          if (payload && payload.success) {
            ...
            if (typeof onSuccess === "function") {
              ...
              ShowRolacoToolsAlert("Success", lt("Custom API added successfully!"));
            }
          } else {
            saveBtn.textContent = lt("Save API");
            saveBtn.disabled = false;
            saveBtn.style.opacity = "1";
            ShowRolacoToolsAlert("Error", payload.error || "Failed to save API.");
          }
        } catch (e) {
          saveBtn.textContent = lt("Save API");
          saveBtn.disabled = false;
          saveBtn.style.opacity = "1";
          ShowRolacoToolsAlert("Error", e.toString());
        }
      });
    };
  ...
  function showSettingsPopup() {
    if (
      document.querySelector(".RolacoTools-settings-overlay") ||
      settingsMenuPending
    )
      return;
    ...
    ensureTranslationsLoaded(false)
      ...
      .finally(function () {
        ...
        if (document.querySelector(".RolacoTools-settings-overlay")) return;

        try {
          const d = document.querySelector(".RolacoTools-overlay");
          if (d) d.remove();
        } catch (_) {}
        ensureRolacoToolsStyles();
        ensureFontAwesome();
        ...
        const overlay = document.createElement("div");
        overlay.className = "RolacoTools-settings-overlay";
        if (!window.__RolacoTools_IS_BIG_PICTURE__) {
          overlay.classList.add("RolacoTools-menu-docked");
        }
        overlay.style.cssText =
          "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";

        const modal = document.createElement("div");
        modal.className = "RolacoTools-modal RolacoTools-menu-modal";
        const colors = getThemeColors();
        ...
        header.className = "RolacoTools-modal-header";
            ...
            try {
              ...
              titleIcon.src =
                p && p.success && p.dataUrl
                  ? p.dataUrl
                  : "RolacoTools/RolacoTools-icon.png";
            } catch (_) {
              titleIcon.src = "RolacoTools/RolacoTools-icon.png";
            }
          });
        } catch (_) {
          titleIcon.src = "RolacoTools/RolacoTools-icon.png";
        ...
        titleText.textContent = t("menu.title", "RolacoTools · Menu");
        title.appendChild(titleIcon);
        title.appendChild(titleText);

        const editionBadge = document.createElement("span");
        editionBadge.className = "RolacoTools-edition-badge";
        editionBadge.textContent = "V2";
        title.appendChild(editionBadge);

        const iconButtons = document.createElement("div");
        iconButtons.className = "RolacoTools-header-actions";
        iconButtons.style.cssText = "display:flex;gap:12px;";

        function createIconButton(id, iconClass, titleKey, titleFallback) {
          const btn = document.createElement("a");
          btn.className = "RolacoTools-icon-button";
          btn.id = id;
          btn.href = "#";
        ...
        const body = document.createElement("div");
        body.className = "RolacoTools-menu-body";
        body.style.cssText =
        ...
        container.className = "RolacoTools-menu-content";
        ...
        function createCardButton(id, key, fallback, iconClass) {
          const btn = document.createElement("a");
          btn.className = "RolacoTools-menu-card";
          btn.id = id;
          btn.href = "#";
          const btnColors = getThemeColors();
        ...
        removeBtn.className = "RolacoTools-menu-secondary-action";
        ...
        removeBtn.innerHTML =
          ...
          t("menu.removeRolacoTools", "Remove via RolacoTools") +
          "</span>";
        ...
        cardGrid.className = "RolacoTools-menu-grid";
        ...
        const fixConnectionBtn = createCardButton(
          "lt-settings-fix-no-connection",
          "menu.fixNoConnection",
          "Fix No Connection",
          "fa-wifi",
        );
        cardGrid.appendChild(fixConnectionBtn);
        ...
        // Desktop opens as a refined panel anchored to the store header.
        // Clicking the dimmed area closes it without changing existing actions.
        ...
        if (checkBtn) {
          checkBtn.addEventListener("click", function (e) {
            ...
            try {
              Millennium.callServerMethod("RolacoTools", "CheckForUpdatesNow", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
        ...
        if (fixConnectionBtn) {
          fixConnectionBtn.addEventListener("click", function (e) {
            e.preventDefault();
            try {
              overlay.remove();
            } catch (_) {}

            showRolacoToolsConfirm(
              "RolacoTools",
              t("menu.fixNoConnection", "Fix No Connection") + "?",
              function () {
                Millennium.callServerMethod("RolacoTools", "FixNoConnection", {
                  contentScriptQuery: "",
                })
                  .then(function (res) {
                    const payload =
                    ...
                    const message =
                      payload && (payload.message || payload.error)
                        ...
                        : "Unable to open Fix No Connection.";
                    ShowRolacoToolsAlert("RolacoTools", message);
                  })
                  .catch(function (err) {
                    ShowRolacoToolsAlert("RolacoTools", String(err));
                  });
              },
              function () {
                showSettingsPopup();
        ...
        if (discordBtn) {
          discordBtn.addEventListener("click", function (e) {
            ...
            const url = "https://discord.gg/mGU77b9X7";
            try {
              Millennium.callServerMethod("RolacoTools", "OpenExternalUrl", {
                url,
                contentScriptQuery: "",
              });
            } catch (_) {}
        ...
        if (fetchApisBtn) {
          fetchApisBtn.addEventListener("click", function (e) {
            ...
            try {
              Millennium.callServerMethod("RolacoTools", "FetchFreeApisNow", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
                  ...
                  ShowRolacoToolsAlert("RolacoTools", text);
                } catch (_) {}
              });
            } catch (_) {}
          });
        ...
        if (fixesMenuBtn) {
          fixesMenuBtn.addEventListener("click", function (e) {
            ...
            try {
              ...
              const appid = match
                ? parseInt(match[1], 10)
                : window.__RolacoToolsCurrentAppId || NaN;
              if (isNaN(appid)) {
                try {
                  overlay.remove();
                } catch (_) {}
                ...
                ShowRolacoToolsAlert("RolacoTools", errText);
                return;
              }

              Millennium.callServerMethod("RolacoTools", "GetGameInstallPath", {
                appid,
                contentScriptQuery: "",
              })
                .then(function (pathRes) {
                  try {
                    ...
                    if (
                      ...
                      window.__RolacoToolsGameInstallPath =
                        pathPayload.installPath;
                    }
                    window.__RolacoToolsGameIsInstalled = isGameInstalled;
                    try {
                      overlay.remove();
                    } catch (_) {}
                    showFixesLoadingPopupAndCheck(appid);
                  } catch (err) {
                    backendLog("RolacoTools: GetGameInstallPath error: " + err);
                    try {
                      overlay.remove();
                    } catch (_) {}
                  }
                ...
                .catch(function () {
                  ...
                  ShowRolacoToolsAlert("RolacoTools", errorText);
                });
            } catch (err) {
              backendLog("RolacoTools: Fixes Menu button error: " + err);
            }
          });
        }
        ...
        try {
          ...
          if (
            ...
            Millennium.callServerMethod("RolacoTools", "HasRolacoToolsForApp", {
              appid,
              contentScriptQuery: "",
            }).then(function (res) {
              try {
                ...
                if (exists) {
                  const doDelete = function () {
                    try {
                      Millennium.callServerMethod(
                        ...
                        .then(function () {
                          try {
                            window.__RolacoToolsButtonInserted = false;
                            window.__RolacoToolsPresenceCheckInFlight = false;
                            window.__RolacoToolsPresenceCheckAppId = undefined;
                            addRolacoToolsButton();
                            const successText = t(
                              "menu.remove.success",
                              "RolacoTools removed for this app.",
                            );
                            ShowRolacoToolsAlert("RolacoTools", successText);
                          } catch (err) {
                            backendLog(
                              "RolacoTools: post-delete cleanup failed: " + err,
                            );
                          }
                        })
                        .catch(function (err) {
                          const failureText = t(
                            "menu.remove.failure",
                            "Failed to remove RolacoTools.",
                          );
                          const errMsg =
                            err && err.message ? err.message : failureText;
                          ShowRolacoToolsAlert("RolacoTools", errMsg);
                        });
                    } catch (err) {
                      backendLog("RolacoTools: doDelete failed: " + err);
                    }
                  };
                  ...
                  removeBtn.onclick = function (e) {
                    ...
                    const confirmMessage = t(
                      "menu.remove.confirm",
                      "Remove via RolacoTools for this game?",
                    );
                    showRolacoToolsConfirm(
                      "RolacoTools",
                      confirmMessage,
  ...
  function ensureTranslationsLoaded(forceRefresh, preferredLanguage) {
    try {
      if (
        !forceRefresh &&
        window.__RolacoToolsI18n &&
        window.__RolacoToolsI18n.ready
      ) {
        return Promise.resolve(window.__RolacoToolsI18n);
      }
      if (
        typeof Millennium === "undefined" ||
        typeof Millennium.callServerMethod !== "function"
      ) {
        window.__RolacoToolsI18n = window.__RolacoToolsI18n || {
          language: "en",
          locales: [],
          strings: {},
          ready: false,
      ...
      const settingsVals =
        ((window.__RolacoToolsSettings || {}).values || {}).general || {};
      const useSteamLang =
      ...
      if (!targetLanguage) {
        ...
        targetLanguage = useSteamLang
          ? steamLang
          : (window.__RolacoToolsI18n && window.__RolacoToolsI18n.language) || "en";
      }
      return Millennium.callServerMethod("RolacoTools", "GetTranslations", {
        ...
        .then(function (res) {
          ...
          return window.__RolacoToolsI18n;
        })
        .catch(function (err) {
          backendLog("RolacoTools: translation load failed: " + err);
          window.__RolacoToolsI18n = window.__RolacoToolsI18n || {
            language: "en",
            locales: [],
            strings: {},
      ...
      backendLog("RolacoTools: ensureTranslationsLoaded error: " + err);
      window.__RolacoToolsI18n = window.__RolacoToolsI18n || {
        language: "en",
        locales: [],
        strings: {},
  ...
  function translateText(key, fallback) {
    ...
    try {
      const store = window.__RolacoToolsI18n;
      if (
        store &&
        store.strings &&
  ...
  function askRestartConfirmation() {
    showRolacoToolsConfirm(
      ...
      function () {
        try {
          Millennium.callServerMethod("RolacoTools", "RestartSteam", {
            contentScriptQuery: "",
          });
  ...
  function showTestPopup() {
    // Avoid duplicates
    if (document.querySelector(".RolacoTools-overlay")) return;
    // Close settings popup if open so modals don't overlap
    try {
      const s = document.querySelector(".RolacoTools-settings-overlay");
      if (s) s.remove();
    } catch (_) {}
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";
    ...
    title.className = "RolacoTools-title";
    ...
    apiListContainer.className = "RolacoTools-api-list";
    ...
    if (
      ...
      Millennium.callServerMethod("RolacoTools", "GetApiList", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          try {
            ...
            if (
              ...
              payload.apis.forEach((api, index) => {
                ...
                apiItem.className = `RolacoTools-api-item RolacoTools-api-${index}`;
    ...
    body.className = "RolacoTools-status";
    body.innerHTML =
    ...
    progressWrap.className = "RolacoTools-progress-wrap";
    ...
    progressBar.className = "RolacoTools-progress-bar";
    progressWrap.appendChild(progressBar);

    const progressInfo = document.createElement("div");
    progressInfo.style.cssText = `display:none;margin-top:8px;font-size:12px;color:${colors.textSecondary};`;
    progressInfo.className = "RolacoTools-progress-info";

    const percent = document.createElement("span");
    percent.className = "RolacoTools-percent";
    percent.textContent = "0%";

    const downloadSize = document.createElement("span");
    downloadSize.className = "RolacoTools-download-size";
    ...
    cancelBtn.className = "RolacoTools-btn RolacoTools-cancel-btn";
    ...
    hideBtn.className = "RolacoTools-btn RolacoTools-hide-btn";
    ...
    function cancelOperation() {
      ...
      try {
        ...
        if (
          ...
          Millennium.callServerMethod("RolacoTools", "CancelAddViaRolacoTools", {
            appid,
            contentScriptQuery: "",
          });
        }
      ...
      const status = overlay.querySelector(".RolacoTools-status");
      if (status) status.textContent = lt("Cancelled");
      const cancelBtn = overlay.querySelector(".RolacoTools-cancel-btn");
      if (cancelBtn) cancelBtn.style.display = "none";
      const hideBtn = overlay.querySelector(".RolacoTools-hide-btn");
      if (hideBtn) hideBtn.innerHTML = `<span>${lt("Close")}</span>`;
      // Hide progress UI
      const wrap = overlay.querySelector(".RolacoTools-progress-wrap");
      const progressInfo = overlay.querySelector(".RolacoTools-progress-info");
  ...
  function showFixesResultsPopup(data, isGameInstalled) {
    if (document.querySelector(".RolacoTools-fixes-results-overlay")) return;
    // Close other popups
    try {
      const d = document.querySelector(".RolacoTools-overlay");
      if (d) d.remove();
    ...
    try {
      const f = document.querySelector(".RolacoTools-fixes-results-overlay");
      if (f) f.remove();
    } catch (_) {}
    try {
      const l = document.querySelector(".RolacoTools-loading-fixes-overlay");
      if (l) l.remove();
    } catch (_) {}
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-fixes-results-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";
    ...
    const titleText = document.createElement("span");
    titleText.textContent = lt("RolacoTools · Fixes Menu");
    title.appendChild(titleIcon);
    title.appendChild(titleText);
    ...
    const genericSection = createFixButton(
      ...
      function (e) {
        ...
        if (genericStatus === 200 && isGameInstalled) {
          const genericUrl =
            "https://files.RolacoTools.work/GameBypasses/" + data.appid + ".zip";
          applyFix(
            data.appid,
            genericUrl,
            lt("Generic Fix"),
    ...
    const onlineSection = createFixButton(
      ...
      function (e) {
        ...
        if (onlineStatus === 200 && isGameInstalled) {
          const onlineUrl =
            data.onlineFix.url ||
            "https://files.RolacoTools.work/OnlineFix1/" + data.appid + ".zip";
          applyFix(
            data.appid,
            onlineUrl,
            lt("Online Fix"),
    ...
    gameFolderBtn.className = "RolacoTools-btn";
    ...
    gameFolderBtn.onclick = function (e) {
      e.preventDefault();
      if (window.__RolacoToolsGameInstallPath) {
        try {
          Millennium.callServerMethod("RolacoTools", "OpenGameFolder", {
            path: window.__RolacoToolsGameInstallPath,
            contentScriptQuery: "",
          });
        } catch (err) {
          backendLog("RolacoTools: Failed to open game folder: " + err);
        }
      }
    };
    ...
    backBtn.className = "RolacoTools-btn";
    ...
    function startUnfix(appid) {
      try {
        Millennium.callServerMethod("RolacoTools", "UnFixGame", {
          appid: appid,
          installPath: window.__RolacoToolsGameInstallPath,
          contentScriptQuery: "",
        })
          .then(function (res) {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
            if (payload && payload.success) {
              ...
              ShowRolacoToolsAlert("RolacoTools", errorMsg);
            }
          })
          .catch(function () {
        ...
        backendLog("RolacoTools: Un-Fix start error: " + err);
      }
    }
  }

  function showFixesLoadingPopupAndCheck(appid) {
    if (document.querySelector(".RolacoTools-loading-fixes-overlay")) return;
    try {
      const d = document.querySelector(".RolacoTools-overlay");
      if (d) d.remove();
    } catch (_) {}
    ...
    try {
      const f = document.querySelector(".RolacoTools-fixes-overlay");
      if (f) f.remove();
    } catch (_) {}
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-loading-fixes-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";
    ...
    fetchFixes(appid)
      .then(function (payload) {
        if (payload && payload.success) {
          const isGameInstalled = window.__RolacoToolsGameIsInstalled === true;
  ...
  function applyFix(appid, downloadUrl, fixType, gameName, resultsOverlay) {
    try {
      ...
      backendLog("RolacoTools: Applying fix " + fixType + " for appid " + appid);

      // Start the download and extraction process
      Millennium.callServerMethod("RolacoTools", "ApplyGameFix", {
        appid: appid,
        ...
        .then(function (res) {
          try {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
            if (payload && payload.success) {
              // Show download progress popup similar to Add via RolacoTools
            ...
            backendLog("RolacoTools: ApplyGameFix response error: " + err);
            const msg = lt("Error applying fix");
            ShowRolacoToolsAlert("RolacoTools", msg);
          }
        })
        .catch(function (err) {
          backendLog("RolacoTools: ApplyGameFix error: " + err);
          const msg = lt("Error applying fix");
          ShowRolacoToolsAlert("RolacoTools", msg);
        });
    } catch (err) {
      backendLog("RolacoTools: applyFix error: " + err);
    }
  }

  // Show fix download progress popup
  function showFixDownloadProgress(appid, fixType) {
    // Reuse the download popup UI from Add via RolacoTools
    if (document.querySelector(".RolacoTools-overlay")) return;
    ...
    const hideBtn = document.createElement("a");
    hideBtn.href = "#";
    hideBtn.className = "RolacoTools-btn";
    ...
    const cancelBtn = document.createElement("a");
    cancelBtn.href = "#";
    cancelBtn.className = "RolacoTools-btn primary";
    ...
    cancelBtn.onclick = function (e) {
      ...
      Millennium.callServerMethod("RolacoTools", "CancelApplyFix", {
        appid: appid,
        contentScriptQuery: "",
      })
        .then(function (res) {
          try {
            ...
            backendLog("RolacoTools: CancelApplyFix response error: " + err);
        ...
        .catch(function (err) {
          ...
          if (msgEl2 && msgEl2.dataset.last)
            msgEl2.textContent = msgEl2.dataset.last;
          backendLog("RolacoTools: CancelApplyFix error: " + err);
          const msg = lt("Failed to cancel fix download");
          ShowRolacoToolsAlert("RolacoTools", msg);
        });
    };
  ...
  function replaceFixButtonsWithClose(overlayEl) {
    ...
    closeBtn.href = "#";
    closeBtn.className = "RolacoTools-btn primary";
  ...
  function pollFixProgress(appid, fixType) {
    const poll = function () {
      try {
        const overlayEl = document.querySelector(".RolacoTools-overlay");
        if (!overlayEl) return; // Stop if overlay was closed

        Millennium.callServerMethod("RolacoTools", "GetApplyFixStatus", {
          appid: appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            ...
            backendLog("RolacoTools: GetApplyFixStatus error: " + err);
          }
        });
      } catch (err) {
        backendLog("RolacoTools: pollFixProgress error: " + err);
      }
    };
    setTimeout(poll, 500);
  }
  ...
  function showUnfixProgress(appid) {
    ...
    try {
      const old = document.querySelector(".RolacoTools-unfix-overlay");
      if (old) old.remove();
    } catch (_) {}
    ...
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-unfix-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:99999;display:flex;align-items:center;justify-content:center;";
  ...
  function pollUnfixProgress(appid) {
    const poll = function () {
      try {
        const overlayEl = document.querySelector(".RolacoTools-unfix-overlay");
        if (!overlayEl) return; // Stop if overlay was closed

        Millennium.callServerMethod("RolacoTools", "GetUnfixStatus", {
          appid: appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
              ...
              if (state.status === "removing") {
                ...
                setTimeout(function () {
                  try {
                    ...
                    backendLog("RolacoTools: Running verify for appid " + appid);
                  } catch (_) {}
                }, 1000);
            ...
            backendLog("RolacoTools: GetUnfixStatus error: " + err);
          }
        });
      } catch (err) {
        backendLog("RolacoTools: pollUnfixProgress error: " + err);
      }
    };
    setTimeout(poll, 500);
  }
  ...
  function fetchSettingsConfig(forceRefresh) {
    try {
      if (
        !forceRefresh &&
        window.__RolacoToolsSettings &&
        Array.isArray(window.__RolacoToolsSettings.schema)
      ) {
        return Promise.resolve(window.__RolacoToolsSettings);
      }
    } catch (_) {}
    ...
    if (
      ...
      return Promise.reject(new Error(lt("RolacoTools backend unavailable")));
    }

    return Millennium.callServerMethod("RolacoTools", "GetSettingsConfig", {
      contentScriptQuery: "",
    }).then(function (res) {
      const payload = typeof res === "string" ? JSON.parse(res) : res;
      if (!payload || payload.success !== true) {
      ...
      window.__RolacoToolsSettings = config;
      return config;
    });
  }
  ...
  function showSettingsManagerPopup(forceRefresh, onBack) {
    if (document.querySelector(".RolacoTools-settings-manager-overlay")) return;

    try {
      const mainOverlay = document.querySelector(".RolacoTools-settings-overlay");
    ...
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-settings-manager-overlay";
    overlay.style.cssText =
    ...
    const modal = document.createElement("div");
    modal.className = "RolacoTools-modal RolacoTools-settings-modal";
    ...
    title.textContent = t("settings.title", "RolacoTools · Settings");
    ...
    searchInput.id = "RolacoTools-settings-search";
    ...
    contentWrap.id = "RolacoTools-content-wrap";
    ...
    scrollbarStyle.textContent =
      "#RolacoTools-content-wrap::-webkit-scrollbar { width: 8px; } " +
      "#RolacoTools-content-wrap::-webkit-scrollbar-track { background: transparent; } " +
      "#RolacoTools-content-wrap::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.15); border-radius: 4px; } " +
      "#RolacoTools-content-wrap::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.25); }";
    ...
    function setStatus(text, color) {
      let statusLine = contentWrap.querySelector(".RolacoTools-settings-status");
      if (!statusLine) {
        statusLine = document.createElement("div");
        statusLine.className = "RolacoTools-settings-status";
    ...
    function renderSettings() {
      ...
      for (let i = 0; i < state.config.schema.length; i++) {
        ...
        for (let j = 0; j < options.length; j++) {
          ...
          labelWrap.className = "RolacoTools-toggle-label-wrap";
          ...
          if (option.type === "toggle") {
            optionEl.classList.add("RolacoTools-toggle-container");
            ...
            toggleLabel.className = "RolacoTools-toggle";
            ...
            slider.className = "RolacoTools-slider";
            ...
            if (option.type === "select") {
              ...
              selectEl.addEventListener("change", function () {
                ...
                if (group.key === "general" && option.key === "theme") {
                  try {
                    backendLog(
                      "RolacoTools: Theme change detected, new value: " +
                        selectEl.value,
                    );
                  } catch (_) {}
                  ...
                  if (
                    window.__RolacoToolsSettings &&
                    window.__RolacoToolsSettings.values
                  ) {
                    if (!window.__RolacoToolsSettings.values.general) {
                      window.__RolacoToolsSettings.values.general = {};
                    }
                    window.__RolacoToolsSettings.values.general.theme =
                      selectEl.value;
                    try {
                      backendLog(
                        "RolacoTools: Updated cache, theme is now: " +
                          window.__RolacoToolsSettings.values.general.theme,
                      );
                    } catch (_) {}
                  }
                  ...
                  setTimeout(function () {
                    ...
                    const contentWrapEl =
                      overlay &&
                      overlay.querySelector("#RolacoTools-content-wrap");
                    if (contentWrapEl) {
              ...
              if (option.key === "morrenusApiKey") {
                ...
                const updateStats = function (key) {
                  ...
                  statsDiv.innerHTML =
                    ...
                    lt("Checking key...");
                  Millennium.callServerMethod("RolacoTools", "GetMorrenusStats", {
                    api_key: key,
                    contentScriptQuery: "",
                  })
    ...
    function renderInstalledFixesSection() {
      ...
      sectionEl.id = "RolacoTools-installed-fixes-section";
      ...
      listContainer.id = "RolacoTools-fixes-list";
    ...
    function renderFixesList() {
      const container = document.getElementById("RolacoTools-fixes-list");
      if (!container) return;
    ...
    function loadInstalledFixes(container) {
      ...
      Millennium.callServerMethod("RolacoTools", "GetInstalledFixes", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          const response = typeof res === "string" ? JSON.parse(res) : res;
          backendLog(
            "RolacoTools: GetInstalledFixes response: " +
              JSON.stringify(response).substring(0, 200),
          );
          if (!response || !response.success) {
            backendLog(
              "RolacoTools: GetInstalledFixes failed - response: " +
        ...
        .catch(function (err) {
          backendLog("RolacoTools: GetInstalledFixes catch error: " + err);
    ...
    function renderApiTogglesSection() {
      const c = getThemeColors();
      const sectionEl = document.createElement("div");
      sectionEl.id = "RolacoTools-api-toggles-section";
        ...
        .then(function(res) {
          ...
          payload.apis.forEach(function(api) {
            ...
            row.addEventListener('dragstart', function(e) {
                ...
                row.classList.add('RolacoTools-dragging');
                row.style.opacity = '0.5';
            });
            row.addEventListener('dragend', function() {
                row.classList.remove('RolacoTools-dragging');
                row.style.opacity = '1';
                row.draggable = false;
                ...
                Millennium.callServerMethod("RolacoTools", "ReorderApis", { apiNames: JSON.stringify(newOrder), contentScriptQuery: "" })
                  .then(function(r) {
            ...
            row.addEventListener('dragover', function(e) {
                ...
                const dragging = listEl.querySelector('.RolacoTools-dragging');
            ...
            nameDisplay.onclick = function() {
              ...
              function commitRename() {
                ...
                if (newVal && newVal !== currentName) {
                  Millennium.callServerMethod("RolacoTools", "RenameApi", { old_name: currentName, new_name: newVal, contentScriptQuery: "" })
                    .then(function(r) {
                      const rp = typeof r === "string" ? JSON.parse(r) : r;
                      if (rp && rp.success) {
                        currentName = newVal;
            ...
            pill.onclick = function() {
              ...
              Millennium.callServerMethod("RolacoTools", "ToggleApi", { apiName: currentName, contentScriptQuery: "" })
                .then(function(r) {
                  const rp = typeof r === "string" ? JSON.parse(r) : r;
                  if (!rp || !rp.success) {
            ...
            delBtn.onclick = function(e) {
              ...
              Millennium.callServerMethod("RolacoTools", "RemoveApi", { apiName: currentName, contentScriptQuery: "" })
                .then(function(r) {
                  const rp = typeof r === "string" ? JSON.parse(r) : r;
                  if (rp && rp.success) {
                    row.style.opacity = "0";
    ...
    function renderLuaList() {
      const container = document.getElementById("RolacoTools-lua-list");
      if (!container) return;
    ...
    function renderInstalledLuaSection() {
      const sectionEl = document.createElement("div");
      sectionEl.id = "RolacoTools-installed-lua-section";
      ...
      const listContainer = document.createElement("div");
      listContainer.id = "RolacoTools-lua-list";
      listContainer.style.cssText = "min-height:50px;";
      sectionEl.appendChild(listContainer);
    ...
    function loadInstalledLuaScripts(container) {
      ...
      Millennium.callServerMethod("RolacoTools", "GetInstalledLuaScripts", {
        contentScriptQuery: "",
      })
        .then(function (res) {
          const response = typeof res === "string" ? JSON.parse(res) : res;
      ...
      luaDeleteBtn.addEventListener("click", function (e) {
        ...
        showRolacoToolsConfirm(
          ...
          function () {
            ...
            Millennium.callServerMethod("RolacoTools", "DeleteRolacoToolsForApp", {
              appid: script.appid,
              contentScriptQuery: "",
            })
              .then(function (res) {
    ...
    saveBtn.addEventListener("click", function (e) {
      ...
      try {
        backendLog(
          "RolacoTools: collectChanges payload " + JSON.stringify(changes),
        );
      } catch (_) {}
      ...
      try {
        backendLog(
          "RolacoTools: sending settings payload " + JSON.stringify(payloadToSend),
        );
      } catch (_) {}
      // Pass flattened keys so Millennium handles the RPC arguments as expected.
      Millennium.callServerMethod("RolacoTools", "ApplySettingsChanges", {
        contentScriptQuery: "",
        ...
        .then(function (res) {
          ...
          try {
            if (window.__RolacoToolsSettings) {
              window.__RolacoToolsSettings.values = JSON.parse(
                JSON.stringify(state.config.values),
              );
              window.__RolacoToolsSettings.schemaVersion =
                state.config.schemaVersion;
              window.__RolacoToolsSettings.lastFetched = Date.now();
              if (
                response &&
                response.translations &&
                typeof response.translations === "object"
              ) {
                window.__RolacoToolsSettings.translations = response.translations;
              }
              if (response && response.language) {
                window.__RolacoToolsSettings.language = response.language;
              }
            }
          } catch (_) {}
          ...
          try {
            if (window.__RolacoToolsSettings) {
              window.__RolacoToolsSettings.schema = null;
            }
          } catch (_) {}
          ...
          if (
            ...
            applyTranslationBundle({
              language:
                response.language ||
                (window.__RolacoToolsI18n && window.__RolacoToolsI18n.language) ||
                "en",
              locales:
                (window.__RolacoToolsI18n && window.__RolacoToolsI18n.locales) ||
  ...
  function closeSettingsOverlay() {
    try {
      ...
      var list = document.getElementsByClassName("RolacoTools-settings-overlay");
      ...
      var list2 = document.getElementsByClassName("RolacoTools-overlay");
  ...
  function showRolacoToolsAlert(title, message, onClose) {
    if (document.querySelector(".RolacoTools-alert-overlay")) return;

    ensureRolacoToolsStyles();
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-alert-overlay";
    overlay.style.cssText =
    ...
    titleEl.textContent = String(title || "RolacoTools");
    ...
    okBtn.href = "#";
    okBtn.className = "RolacoTools-btn primary";
    okBtn.style.cssText =
  ...
  function ShowRolacoToolsAlert(title, message) {
    try {
      showRolacoToolsAlert(title, message);
    } catch (err) {
      backendLog("RolacoTools: Alert error, falling back: " + err);
      try {
        alert(String(title) + "\n\n" + String(message));
      } catch (_) {}
    }
  ...
  function showRolacoToolsConfirm(title, message, onConfirm, onCancel) {
    // Always close settings popup first so the confirm is visible on top
    closeSettingsOverlay();

    // Create custom modern confirmation dialog
    if (document.querySelector(".RolacoTools-confirm-overlay")) return;

    ensureRolacoToolsStyles();
    ensureFontAwesome();
    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-confirm-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:100001;display:flex;align-items:center;justify-content:center;";
    ...
    const cancelBtn = document.createElement("a");
    cancelBtn.href = "#";
    cancelBtn.className = "RolacoTools-btn";
    cancelBtn.style.cssText =
    ...
    confirmBtn.href = "#";
    confirmBtn.className = "RolacoTools-btn primary";
  ...
  function showDlcWarning(appid, fullgameAppid, fullgameName) {
    ...
    closeSettingsOverlay();
    if (document.querySelector(".RolacoTools-dlc-warning-overlay")) return;

    ensureRolacoToolsStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-dlc-warning-overlay RolacoTools-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:100001;display:flex;align-items:center;justify-content:center;";
    ...
    goBtn.className = "RolacoTools-btn primary";
    goBtn.style.cssText =
  ...
  function showRolacoToolsPlayableWarning(message, onProceed, onCancel) {
    // Close settings so modal is visible
    closeSettingsOverlay();
    if (document.querySelector(".RolacoTools-playable-warning-overlay")) return;

    ensureRolacoToolsStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-playable-warning-overlay RolacoTools-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.8);backdrop-filter:blur(12px);z-index:100001;display:flex;align-items:center;justify-content:center;";
    ...
    proceedBtn.href = "#";
    proceedBtn.className = "RolacoTools-btn primary";
  ...
  function showMillenniumDisclaimerModal() {
    if (document.querySelector(".RolacoTools-disclaimer-overlay")) return;

    ensureRolacoToolsStyles();
    ensureFontAwesome();

    const overlay = document.createElement("div");
    overlay.className = "RolacoTools-disclaimer-overlay RolacoTools-overlay";
    overlay.style.cssText =
    ...
    line1.textContent = t(
      "disclaimer.line1",
      "RolacoTools is not affiliated with Millennium",
    );
    ...
    confirmBtn.onclick = function (e) {
      ...
      if (input.value.trim().toLowerCase() === expectedPhrase) {
        localStorage.setItem("RolacoTools millennium disclaimer accepted", "1");
        overlay.remove();
      }
    };
  ...
  function ensureStyles() {
    if (!document.getElementById("RolacoTools-spacing-styles")) {
      const style = document.createElement("style");
      style.id = "RolacoTools-spacing-styles";
      style.textContent = `
                .RolacoTools-restart-button { margin-left: 6px !important; margin-right: 6px !important; }
                .RolacoTools-button { margin-right: 0 !important; position: relative !important; }
                .RolacoTools-pills-container {
                ...
                .RolacoTools-pill.red { background: rgba(255, 80, 80, 0.15); color: #ff5050; border: 1px solid rgba(255, 80, 80, 0.3); }
                .RolacoTools-pill.green { background: rgba(92, 184, 92, 0.15); color: #5cb85c; border: 1px solid rgba(92, 184, 92, 0.3); }
                .RolacoTools-pill.yellow { background: rgba(255, 193, 7, 0.15); color: #ffc107; border: 1px solid rgba(255, 193, 7, 0.3); }
                .RolacoTools-pill.orange { background: rgba(255, 136, 0, 0.15); color: #ff8800; border: 1px solid rgba(255, 136, 0, 0.3); }
                .RolacoTools-pill.gray { background: rgba(150, 150, 150, 0.15); color: #a0a0a0; border: 1px solid rgba(150, 150, 150, 0.3); }
            `;
  ...
  function updateButtonTranslations() {
    try {
      ...
      const restartBtn = document.querySelector(".RolacoTools-restart-button");
      if (restartBtn) {
      ...
      // Keep the store entry point branded consistently across all languages.
      const RolacoToolsBtn = document.querySelector(".RolacoTools-button");
      if (RolacoToolsBtn) {
        const addViaText = lt("Add Game");
        RolacoToolsBtn.title = addViaText;
        RolacoToolsBtn.setAttribute("data-tooltip-text", addViaText);
        const span = RolacoToolsBtn.querySelector("span");
        if (span) {
          span.textContent = addViaText;
        }
      }
    } catch (err) {
      backendLog("RolacoTools: updateButtonTranslations error: " + err);
    }
  }

  // Function to add the RolacoTools button
  ...
  function addRolacoToolsButton() {
    ...
    // The store buttons can appear before any modal is opened. Ensure the
    // active theme tokens exist before styling those entry points.
    if (!document.getElementById("RolacoTools-styles")) {
      ensureRolacoToolsStyles();
    }

    // Track current URL to detect page changes
    const currentUrl = window.location.href;
    if (window.__RolacoToolsLastUrl !== currentUrl) {
      // Page changed - reset button insertion flag and update translations
      window.__RolacoToolsLastUrl = currentUrl;
      window.__RolacoToolsButtonInserted = false;
      window.__RolacoToolsRestartInserted = false;
      window.__RolacoToolsIconInserted = false;
      window.__RolacoToolsHeaderInserted = false;
      window.__RolacoToolsPresenceCheckInFlight = false;
      window.__RolacoToolsPresenceCheckAppId = undefined;
    ...
    if (
      headerContainer &&
      !document.querySelector(".RolacoTools-header-button") &&
      !window.__RolacoToolsHeaderInserted
    ) {
      ensureRolacoToolsStyles();
      const headerBtn = document.createElement("button");
      headerBtn.type = "button";
      headerBtn.className = "RolacoTools-header-button Focusable";
      headerBtn.tabIndex = "0";
      headerBtn.title = "RolacoTools Settings";
      headerBtn.setAttribute("data-tooltip-text", "RolacoTools Settings");
      ...
      window.__RolacoToolsHeaderInserted = true;
      backendLog("Inserted store header button");
    }

    // Check if we're in Big Picture mode
    const isBigPicture = window.__RolacoTools_IS_BIG_PICTURE__;
    ...
    if (targetContainer) {
      ...
      // Insert a Restart Steam button between Community Hub and our RolacoTools button
      try {
        if (
          !document.querySelector(".RolacoTools-restart-button") &&
          !window.__RolacoToolsRestartInserted
        ) {
          ensureStyles();
          ...
          if (referenceBtn && referenceBtn.className) {
            restartBtn.className =
              referenceBtn.className + " RolacoTools-restart-button";
          } else {
            restartBtn.className =
              "btnv6_blue_hoverfade btn_medium RolacoTools-restart-button";
          }
          restartBtn.href = "#";
          const restartText = lt("Restart Steam");
          restartBtn.title = restartText;
          ...
          window.__RolacoToolsRestartInserted = true;
      ...
      const existingBtn = document.querySelector(".RolacoTools-button");
      if (existingBtn) {
        ensureTranslationsLoaded(false).then(function () {
          updateButtonTranslations();
        });
      ...
      if (!existingBtn && !window.__RolacoToolsButtonInserted) {
        // Create the RolacoTools button modeled after existing SteamDB/PCGW buttons
        // In Big Picture mode, use queue button as reference; otherwise use first link in container
        ...
        // Use same custom button for both modes
        const RolacoToolsButton = document.createElement("a");
        RolacoToolsButton.href = "#";
        // Copy classes from an existing button to match look-and-feel, but set our own label
        if (referenceBtn && referenceBtn.className) {
          RolacoToolsButton.className =
            referenceBtn.className + " RolacoTools-button";
        } else {
          RolacoToolsButton.className =
            "btnv6_blue_hoverfade btn_medium RolacoTools-button";
        }
        const span = document.createElement("span");
        const addViaText = lt("Add Game");
        span.textContent = addViaText;
        RolacoToolsButton.appendChild(span);
        // Tooltip/title
        RolacoToolsButton.title = addViaText;
        RolacoToolsButton.setAttribute("data-tooltip-text", addViaText);

        // Normalize margins to match native buttons
        try {
          if (referenceBtn) {
            const cs = window.getComputedStyle(referenceBtn);
            RolacoToolsButton.style.marginLeft = cs.marginLeft;
            RolacoToolsButton.style.marginRight = cs.marginRight;
          }
        } catch (_) {}

        // Local click handler suppressed; delegated handler manages actions
        RolacoToolsButton.addEventListener("click", function (e) {
          e.preventDefault();
          backendLog(
            "RolacoTools button clicked (delegated handler will process)",
          );
        });

        // Before inserting, ask backend if RolacoTools already exists for this appid
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            if (
              window.__RolacoToolsPresenceCheckInFlight &&
              window.__RolacoToolsPresenceCheckAppId === appid
            ) {
              return;
            }
            window.__RolacoToolsPresenceCheckInFlight = true;
            window.__RolacoToolsPresenceCheckAppId = appid;
            window.__RolacoToolsCurrentAppId = appid;
            Millennium.callServerMethod("RolacoTools", "HasRolacoToolsForApp", {
              appid,
              contentScriptQuery: "",
            }).then(function (res) {
              try {
                ...
                if (payload && payload.success && payload.exists === true) {
                  backendLog(
                    "RolacoTools already present for this app; not inserting button",
                  );
                  window.__RolacoToolsPresenceCheckInFlight = false;
                ...
                if (
                  !document.querySelector(".RolacoTools-button") &&
                  !window.__RolacoToolsButtonInserted
                ) {
                  // Insert after restart button (order: Restart → Add)
                  const restartExisting = steamdbContainer.querySelector(
                    ".RolacoTools-restart-button",
                  );
                  if (restartExisting && restartExisting.after) {
                    restartExisting.after(RolacoToolsButton);
                  } else if (referenceBtn && referenceBtn.after) {
                    referenceBtn.after(RolacoToolsButton);
                  } else {
                    steamdbContainer.appendChild(RolacoToolsButton);
                  }
                  window.__RolacoToolsButtonInserted = true;
                  backendLog("RolacoTools button inserted");
                }
                window.__RolacoToolsPresenceCheckInFlight = false;
              } catch (_) {
                if (
      ...
      try {
        ...
        if (!isNaN(appid)) {
          const pillBtn = steamdbContainer.querySelector(".RolacoTools-button");
          if (pillBtn) {
            ...
            if (
              ...
              fetchGamesDatabase().then(function (db) {
                const btn = steamdbContainer.querySelector(".RolacoTools-button");
                if (!btn) return;
                ...
                if (!pillsContainer) {
                  ...
                  pillsContainer.className = "RolacoTools-pills-container";
                ...
                fetchFixes(appid).then(function (fixesData) {
                  ...
                  if (status !== "untested") {
                    ...
                    pill.className = "RolacoTools-pill";
                    if (status === "playable") {
                  ...
                  // reset button state
                  const btn =
                    steamdbContainer.querySelector(".RolacoTools-button");
                  if (btn) {
                    btn.style.opacity = "";
                    ...
                    if (span && span.textContent === "Unplayable") {
                      span.textContent = lt("Add Game");
                    }
                  }

                  if (showDenuvoPill) {
                    const pill = document.createElement("span");
                    pill.className = "RolacoTools-pill orange";
      ...
      if (!logState.missingOnce) {
        backendLog("RolacoTools: steamdbContainer not found on this page");
  ...
  function onFrontendReady() {
            ...
            if (window.location.hostname === "store.steampowered.com") {
              if (
                localStorage.getItem(
                  "RolacoTools millennium disclaimer accepted",
                ) !== "1"
              ) {
    ...
    setTimeout(function () {
      if (
        ...
        backendLog("[RolacoTools] Gamepad detected - Navigation enabled");

        // Only show visual hint in Big Picture mode
        if (window.__RolacoTools_IS_BIG_PICTURE__) {
          const hint = document.createElement("div");
          hint.id = "RolacoTools-gamepad-hint";
          ...
          if (!document.querySelector("#RolacoTools-gamepad-hint-styles")) {
            const style = document.createElement("style");
            style.id = "RolacoTools-gamepad-hint-styles";
            style.textContent =
              "\
                            @keyframes fadeInOut {\
    ...
    try {
      if (
        ...
        Millennium.callServerMethod("RolacoTools", "GetInitApisMessage", {
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            const payload = typeof res === "string" ? JSON.parse(res) : res;
        ...
        try {
          if (window.location.hostname === "store.steampowered.com") {
            if (!sessionStorage.getItem("RolacoToolsLoadedAppsGate")) {
              sessionStorage.setItem("RolacoToolsLoadedAppsGate", "1");
              Millennium.callServerMethod("RolacoTools", "ReadLoadedApps", {
                contentScriptQuery: "",
              }).then(function (res) {
                try {
                  const payload =
  ...
  document.addEventListener(
    ...
    function (evt) {
      ...
      const anchor = evt.target.closest(".RolacoTools-button");
      if (anchor) {
        evt.preventDefault();
        evt.stopPropagation(); // Stop propagation to avoid conflicts
        backendLog("RolacoTools delegated click");
        try {
          const match =
            window.location.href.match(
              /https:\/\/store\.steampowered\.com\/app\/(\d+)/,
          ...
          if (
            ...
            if (runState.inProgress && runState.appid === appid) {
              backendLog(
                "RolacoTools: operation already in progress for this appid",
              );
              return;
            }
            ...
            const continueWithAdd = function () {
              ...
              showTestPopup();
              const overlay = document.querySelector(".RolacoTools-overlay");
              const status = overlay
                ? overlay.querySelector(".RolacoTools-status")
                : null;
              const apiList = overlay
                ? overlay.querySelector(".RolacoTools-api-list")
                : null;

              if (status)
                status.textContent = lt("Searching across sources...");

              Millennium.callServerMethod("RolacoTools", "CheckApisForApp", {
                appid,
                contentScriptQuery: "",
              })
                .then(function (res) {
                  try {
                    ...
                    if (available.length === 0) {
                      ...
                      const hideBtn = overlay
                        ? overlay.querySelector(".RolacoTools-hide-btn")
                        : null;
                      if (hideBtn)
                    ...
                    try {
                      if (
                        ...
                        if (
                          typeof window.__RolacoToolsSettings.values.general
                    ...
                    if (isFastDownload) {
                      ...
                      backendLog(
                        "RolacoTools: Auto-selecting source via fast download: " + source.name,
                      );
                    ...
                    backendLog("RolacoTools: CheckApisForApp error: " + err);
                    if (status)
                ...
                .catch(function (err) {
                  backendLog("RolacoTools: CheckApisForApp promise error: " + err);
                });
            };
              ...
              const performDownload = function () {
                ...
                const onFailedCallback = function (errMsg) {
                  if (index + 1 < availableSources.length) {
                    backendLog(
                      "RolacoTools: Fast download failed on " +
                        apiName +
                        " (" +
                        errMsg +
                        "). Trying next API: " +
              ...
              if (apiName && apiName.toLowerCase().includes("morrenus")) {
                ...
                try {
                  if (
                    window.__RolacoToolsSettings &&
                    window.__RolacoToolsSettings.values &&
                    window.__RolacoToolsSettings.values.advanced
                  ) {
                    hubcapKey =
                      window.__RolacoToolsSettings.values.advanced
                        .morrenusApiKey || "";
                  ...
                  if (!hubcapKey) {
                    for (const group in window.__RolacoToolsSettings.values) {
                      if (
                        window.__RolacoToolsSettings.values[group] &&
                        window.__RolacoToolsSettings.values[group].morrenusApiKey
                      ) {
                        hubcapKey =
                          window.__RolacoToolsSettings.values[group]
                            .morrenusApiKey;
                  ...
                  Millennium.callServerMethod("RolacoTools", "GetMorrenusStats", {
                    ...
                    .then((res) => {
                      if (
                        ...
                        showRolacoToolsPlayableWarning(
                          lt(
                    ...
                    .catch((e) => {
                      backendLog(
                        "RolacoTools: Error checking Morrenus API limit: " + e,
                      );
            ...
            function showSourceSelectionModal(appid, available) {
              ...
              const colors = getThemeColors();
              const title = overlay.querySelector(".RolacoTools-title");
              const status = overlay.querySelector(".RolacoTools-status");
              const apiList = overlay.querySelector(".RolacoTools-api-list");
              ...
              if (apiList) {
                ...
                available.forEach((source) => {
                  const btn = document.createElement("a");
                  btn.href = "#";
                  btn.className = "RolacoTools-btn focusable";
  ...
  function startPolling(appid, onFailedCallback) {
    ...
    const timer = setInterval(() => {
      ...
      try {
        Millennium.callServerMethod("RolacoTools", "GetAddViaRolacoToolsStatus", {
          appid,
          contentScriptQuery: "",
        }).then(function (res) {
          try {
            ...
            const overlay = document.querySelector(".RolacoTools-overlay");
            const title = overlay
              ? overlay.querySelector(".RolacoTools-title")
              : null;
            const status = overlay
              ? overlay.querySelector(".RolacoTools-status")
              : null;
            const wrap = overlay
              ? overlay.querySelector(".RolacoTools-progress-wrap")
              : null;
            const progressInfo = overlay
              ? overlay.querySelector(".RolacoTools-progress-info")
              : null;
            const percent = overlay
              ? overlay.querySelector(".RolacoTools-percent")
              : null;
            const downloadSize = overlay
              ? overlay.querySelector(".RolacoTools-download-size")
              : null;
            const bar = overlay
              ? overlay.querySelector(".RolacoTools-progress-bar")
              : null;

            // Update individual API status in the list
            if (overlay) {
              const colors = getThemeColors();
              const apiItems = overlay.querySelectorAll(".RolacoTools-api-item");
              ...
              if (
                ...
                apiItems.forEach((item) => {
                  ...
                  const apiStatus = item.querySelector(".RolacoTools-api-status");
                  if (!apiStatus) return;
            ...
            if (st.status === "checking" && st.currentApi && title) {
              title.textContent = lt("RolacoTools · {api}").replace(
                "{api}",
                st.currentApi,
              );
            } else if (
              ...
              title.textContent = t("common.appName", "RolacoTools");
            }
            ...
            if (
              ...
              const cancelBtn = overlay
                ? overlay.querySelector(".RolacoTools-cancel-btn")
                : null;
            ...
            if (["checking content", "done"].includes(st.status)) {
              ...
              if (title) title.textContent = t("common.appName", "RolacoTools");
            ...
            if (st.status === "done") {
              ...
              if (overlay) {
                ...
                const hideBtn = overlay.querySelector(".RolacoTools-hide-btn");
                if (hideBtn) {
                  hideBtn.className = "RolacoTools-btn primary RolacoTools-hide-btn";
                  hideBtn.style.cssText =
                    "min-width:140px;display:flex;align-items:center;justify-content:center;text-align:center;";
                  hideBtn.innerHTML =
              ...
              const btnEl = document.querySelector(".RolacoTools-button");
  ...
  setTimeout(addRolacoToolsButton, 1000);
  setTimeout(addRolacoToolsButton, 3000);
  ...
  function bootSettings() {
    ...
    loadThemes().then(function() {
        ...
        if (typeof ensureRolacoToolsStyles === "function") ensureRolacoToolsStyles();
    }).catch(function(e) {
        try { backendLog("RolacoTools: Boot sequence failed: " + String(e)); } catch(_) {}
    });
  }
  bootSettings();
  ...
  function showLoadedAppsPopup(apps) {
    // Avoid duplicates
    if (document.querySelector(".RolacoTools-loadedapps-overlay")) return;
    ensureFontAwesome();
    ensureRolacoToolsStyles();
    const overlay = document.createElement("div");
    overlay.style.cssText =
    ...
    overlay.className = "RolacoTools-loadedapps-overlay";
    overlay.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,0.75);backdrop-filter:blur(8px);z-index:99999;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.2s ease-out;";
    overlay.className = "RolacoTools-loadedapps-overlay";
    overlay.style.cssText =
    ...
    title.textContent = lt("RolacoTools · Added Games");
    const body = document.createElement("div");
    ...
    dismissBtn.className = "RolacoTools-btn";
    dismissBtn.innerHTML = "<span>" + lt("Dismiss") + "</span>";
    dismissBtn.href = "#";
    dismissBtn.onclick = function (e) {
      e.preventDefault();
      try {
        Millennium.callServerMethod("RolacoTools", "DismissLoadedApps", {
          contentScriptQuery: "",
        });
      } catch (_) {}
      try {
        sessionStorage.setItem("RolacoToolsLoadedAppsShown", "1");
      } catch (_) {}
      overlay.remove();
    };
